...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/album.css">
<!--加载meta IE兼容文件-->
<!--[if lt IE 9]>
...
<body style="background: white;">
  ...
  <div class="album-content w1000"  id="layer-photos-demo" class="layer-photos-demo">
    <div class="img-info">
      <img src="${pageContext.request.contextPath}/static/images/img/xc_img1.jpg" alt="">
      <div class="title">
      ...
      <div class="layui-fluid" style="padding:0">
        <div class="layui-row layui-col-space30 space">
          <div class="layui-col-xs12 layui-col-sm4 layui-col-md4">
            <div class="item">
              <img src="${pageContext.request.contextPath}/static/images/img/xc_img3.jpg">
              <div class="cont-text">
          ...
          <div class="layui-col-xs12 layui-col-sm4 layui-col-md4">
            <div class="item">
              <img src="${pageContext.request.contextPath}/static/images/img/xc_img4.jpg">
              <div class="cont-text">
                <div class="data">2018/08/08</div>
                <p class="address"><i class="layui-icon layui-icon-location"></i><span>江西九江</span></p>
                <p class="briefly">今日天气晴朗,庐山一日游</p>
          ...
          <div class="layui-col-xs12 layui-col-sm4 layui-col-md4">
            <div class="item">
              <img src="${pageContext.request.contextPath}/static/images/img/xc_img5.jpg">
              <div class="cont-text">
                <div class="data">2018/08/08</div>
                <p class="address"><i class="layui-icon layui-icon-location"></i><span>江西九江</span></p>
                <p class="briefly">今日天气晴朗,庐山一日游</p>
  ...
  <div class="footer-wrap">
    <div class="footer w1000">
      <div class="qrcode">
        <img src="${pageContext.request.contextPath}/static/images/img/erweima.jpg">
      </div>
      <div class="practice-mode">
        <img src="${pageContext.request.contextPath}/static/images/img/down_img.jpg">
        <div class="text">
