...
<table id="dg" title="博客管理" class="easyui-datagrid" 
  ...
  <thead>
  	<tr>
  		<!-- 将传进来的  blog list  传进来的 通过下述的 field  进行  -->
  		<th field="cb" checkbox="true" align="center"></th>
  		<th field="id" width="100" align="center">编号</th>
  		<th field="title" width="500" align="center" formatter="formatTitle">标题</th>
  		<th field="releaseDate" width="100" align="center">发布日期</th>
  		<th field="blogType" width="150" align="center" formatter="formatBlogType">博客类型</th>
  	</tr>
  </thead>
</table>
<div id="tb">
